...
modules.define('calc', ['i-bem-dom', 'calc__value', 'calc__section', 'calc__get', 'range-slider'], function
  ...
  provide(bemDom.declBlock(this.name, {
    ...
    _getRangeValues: function() {
      this._rangeSliders.forEach(function(rangeSlider) {
        this._values[rangeSlider.params.name] = this._formatRangeSliderValue(rangeSlider.getVal());
      }, this);
    },
    ...
    _rangeSliderUpd: function(e, data) {
      ...
      var valueElems = (this._elems(Calc__Value) || []).filter(function(val) {
    ...
    _calculation: function() {
      var values    = this._values,
          ...
          totalElem = this._elem({ elem: Calc__Value, modName: 'name', modVal: 'total' }),
          dateElem  = this._elem({ elem: Calc__Value, modName: 'name', modVal: 'date' });
          monthly   = this._elem({ elem: Calc__Value, modName: 'name', modVal: 'monthly' });

      let baseUrl = 'https://finza.ru/main/anketa/?';
      let linkFirst = document.getElementById('linkFirstTime');
      let linkSecond = document.getElementById('linkSecondTime');
      const totalSum = document.getElementById('bottomCalcValue');
      const dayCount = document.getElementById('bottomCalcDate');
      if (sum > 5000 || sum === 9500) {
        if(linkFirst.hasAttribute('href') && sum !== 9500) {
          linkFirst.removeAttribute('href');
        } else if (sum === 9500) {
          linkFirst.href = baseUrl + 'initialDays=' + time + '&initialSum=5000'
        }
        totalSum.dataset.value = 5000;
      } else {
        linkFirst.href = baseUrl + 'initialDays=' + time + '&initialSum=' + sum;
        totalSum.dataset.value = sum;
      }

      dayCount.dataset.date = time;
      linkSecond.href = baseUrl + 'initialDays=' + time + '&initialSum=' + sum;

      date = new Date(date['set' + dateType](date['get' + dateType]() + time));
      ...
      monthly && dateType.toLowerCase() == 'month' &&
        monthly.setContent(new Intl.NumberFormat('ru-RU').format(Math.ceil(total / time)));


      dayCount.innerHtml = dateElem.setContent(
          (date.getDate() < 10 ? "0" + date.getDate() : date.getDate())
          + '.' +
          ((date.getMonth() + 1) < 10 ? "0" + (date.getMonth() + 1) : date.getMonth() + 1 )
          + '.' +
    ...
    lazyInit: true,
    onInit: function() {
      this._events(RangeSlider).on('update', this.prototype._rangeSliderUpd);
...
modules.define('calc__get', ['i-bem-dom', 'button'], function(provide, bemDom, Button) {
...
modules.define('range-slider', ['i-bem-dom', 'range-slider__container', 'nouislider', 'wnumb'], function (provide, bemDom, RangeSlider__Container, noUiSlider, wNumb) {
...
/* ../../5th.blocks/common.blocks/polyfill/__isinteger/polyfill__isinteger.js end */
  ...
  provide(bemDom.declBlock(this.name, {
    ...
    _init: function() {
      this._noUiSlider = this._container? this._container.domElem[0]: this.domElem[0];

      var options   = this.params.options,
          tooltips  = this.params.tooltips;

      if (options.tooltips && tooltips && Number.isInteger(tooltips.decimals)) {
       ...
       */
      this._noUiSlider.noUiSlider.on('update', this._onNoUiSliderUpdate.bind(this));
    },

    /**
     * @see https://refreshless.com/nouislider/events-callbacks/#section-binding
     */
    _onNoUiSliderUpdate: function(values, handle, unencoded, tap, positions) {
...
modules.define('range-slider__container', ['i-bem-dom'], function(provide, bemDom) {
...
modules.define('tab', ['i-bem-dom', 'jquery__hasScrollBar', 'tab__control', 'tab__option'], function(provide, bemDom, $, Tab__control, Tab__option) {
  ...
  provide(bemDom.declBlock(this.name, {
    ...
    _scrolling: function() {
      ...
      radios.forEach(function(radio) {
        if (radio == radio_checked.get(0) || radio_checked.get(0).domElem.index() < radio.domElem.index()) return;
    ...
    lazyInit: true,
    onInit: function() {
      this._events(Tab__control).on('change', this.prototype._onControlChange);
      return this.__base.apply(this, arguments);
    }
  }));
...
modules.define('tab__control', ['i-bem-dom', 'menu'], function(provide, bemDom, Menu, Tab__control) {
...
modules.define('tab', ['i-bem-dom', 'radio'], function(provide, bemDom, Radio, Tab) {
...
modules.define('range-slider', ['i-bem-dom', 'BEMHTML', 'jquery', 'next-tick'], function(provide, bemDom, BEMHTML, $, nextTick, RangeSlider) {
...
modules.define('carousel', ['i-bem-dom', 'jquery__slick'], function(provide, bemDom, $, Carousel) {
  ...
  provide(Carousel.declMod({ modName: 'type', modVal: 'slick' }, {
    ...
    _initCarousel: function() {
      ...
      this._$container = this.params.container ? this.domElem.find(this.params.container): this.domElem;

      this._instance   = this._$container.on('init', this._onSlickInit.bind(this));
      ...
      this._$container.on('beforeChange', this._beforeSlickChange.bind(this));
...
modules.define('tab', ['carousel', 'next-tick'], function(provide, Carousel, nextTick, Tab) {
...
modules.define('tab__control', ['i-bem-dom', 'radio-group'], function(provide, bemDom, RadioGroup, Tab__control) {
  ...
  provide(Tab__control.declMod({ modName: 'type', modVal: 'radio' }, {
    ...
    lazyInit: true,
    onInit: function() {
      this._events(RadioGroup).on('change', this.prototype._onControlChange);
      return this.__base.apply(this, arguments);
    }
  }));
...
var api = new BEMHTML({"elemJsInstances":true,"exportName":"BEMHTML","sourceMap":{"from":"micro.browser.bemhtml.js"},"to":"/home/mfp/projects/finza.ru/page_layouts"});
...
//# sourceMappingURL=data:application/json;base64,